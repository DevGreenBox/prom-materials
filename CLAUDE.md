...
О бизнесе
Что вы продаёте?: Пром-автоматика
электрооборудование

Ценовой сегмент: 
Средний
Премиум
Примерно товаров будет на сайте: Более 2000
Текущий сайт клиента: http://www.avito.ru/himki-prom
Функционал сайта
...
Фильтры в каталоге
Поиск по сайту
Акции и скидки (возможно скидки,если оптом от какого-то кол-ва или суммы)
Автоматическое создание накладной
Цена доставки считается автоматически
Фильтр по производителю, мощности.
Интеграции, которые должны быть на сайте:
Уведомления на почту
Дизайн сайта
Фирменный стиль который есть: 
Не имеется
Фирменные цвета - серо-голубой, сама страница белая, чтобы текст читался как страница в книге.
В какой стилистике пакуем бренд: 
Свой стиль
минимализм, чтобы было понятно.
Какие сайты нравятся: 
понятный как у все инструменты ру

https://www.vseinstrumenti.ru/

(чтобы быстро работало, без перегрузок визуальных), чтобы в каталоге у товаров были подгруппы.
важен поиск с фильтром.

https://bippa.ru/catalog/barery_i_moduli/
вот еще пример  - сайт знакомых
но добавить в фильтр напряжение / ток / квт / кол-во полюсов
